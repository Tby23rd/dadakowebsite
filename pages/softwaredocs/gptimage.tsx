            ...
            <main className="py-10">
                <div className="mx-auto px-4 ">
                    ...
                    <div className='flex space-x-4 flex-col md:flex-row md:flex-wrap'>
                        {/* User Story */}
                        <section className="mb-8 flex flex-col md:w-1/2 shadow-md p-6 rounded-lg bg-white">
                    ...
                    <div className='flex space-x-4 flex-col md:flex-row md:flex-wrap'>
                        ...
                        {/* Technology Stack */}
                        <section className="mb-8 flex flex-col md:w-1/3 shadow-md p-6 rounded-lg bg-white">
